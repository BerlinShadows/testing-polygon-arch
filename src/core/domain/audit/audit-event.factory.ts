...
export class AuditEventFactory {
    ...
    static roleCreated(roleId: string, name: string, description: string): AuditEvent {
        return new AuditEvent(
    ...
    static roleUpdated(roleId: string, name: string, description: string): AuditEvent {
        return new AuditEvent(
            AuditProvider.RoleService,
    ...
    static scenarioCompleted(scenarioName: string, durationMs: number): AuditEvent {
        return new AuditEvent(
            AuditProvider.AuditService,
