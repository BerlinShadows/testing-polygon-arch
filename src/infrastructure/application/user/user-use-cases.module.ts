    ...
    providers: [
        {
            ...
            ) => new CreateUserUseCase(userRepo, roleRepo, sendNotification, sendMessage),
            inject: [UserRepositoryPort, RoleRepositoryPort, SendNotificationUseCase, SendMessageUseCase],
        },
        {
